...
extension ToastViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 2:
            ...
            content.detail = "This operation is dangerous!"
            content.duration = 2.0
            content.contentInset = .init(top: 10.0, left: 12.0, bottom: 10.0, right: 12.0)
        ...
        case 5:
            let content = FSToastContent(style: .hint)
            content.text = "This is a toast with dismission handler, see console output."
            content.duration = 3.0
            ...
            self.fs.show(content: content)
        case 6:
            self.fs.showLoading("正在请求...", isUserInteractionEnabled: true)
        case 7:
        ...
        case 9:
            ...
            self.fs.show(content: content)
        case 10:
            self.fs.show(hint: "This toast forbids user touching the container view.", isUserInteractionEnabled: false)
        case 11:
            FSToast.showLoading("正在登录...")
